...
if __name__ == '__main__':
    ...
    selected_metrics = st.sidebar.selectbox(label="Disease Selection", options=['Select disease...','Multi-disease','AD','PD','ALS','FTD','LBD'])
    ...
    if selected_metrics != 'Select disease...':
